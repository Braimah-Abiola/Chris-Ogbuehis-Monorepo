      ...
      <MaxWidthWrapper className="flex flex-col items-center justify-center text-center h-screen">
        <div className="z-10 items-center justify-center flex flex-col -mt-10 md:-mt-0">
          ...
          <p className=" mt-2 md:mt-5 max-w-prose text-lg text-zinc-200 text-center">
            Our AI-driven inventory management systems, customer behavior
            analytics, and personalized marketing chatbots are helping retailers
            optimize operations and boost sales.
          </p>
        </div>

        <div className="absolute bg-black/50 z-[3] w-screen h-screen md:h-[114vh]" />
