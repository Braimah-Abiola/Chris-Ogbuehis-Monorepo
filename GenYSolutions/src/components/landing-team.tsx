    ...
    <div>
      <MaxWidthWrapper className="flex flex-col items-start justify-center text-center pt-[15rem] pb-[15rem]">
        <div className="w-full flex flex-row ">
          ...
          <div className="md:ml-60 flex flex-col w-full">
            <div className="flex flex-row w-full justify-between">
              <h2 className=" lg:text-6xl font-medium">Our Team</h2>
              <p>2018-2023</p>
            </div>

            <div className="flex flex-row justify-between md:mt-20">
              <div className="flex flex-col items-start">
                <div className="flex items-center justify-center w-[400px] h-[400px] bg-gray-200 rounded-[20px]">
                  <Image
                    width={170}
                    height={170}
                ...
                <h3 className="text-3xl mt-6">Yaw Bawuah</h3>
