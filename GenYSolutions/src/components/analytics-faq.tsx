    ...
    <MaxWidthWrapper className="bg-white py-32 md:py-60 flex flex-col items-start justify-center text-center">
      ...
      <div className="flex flex-col justify-center w-full space-y-4 mt-12 md:mt-20">
        ...
        >
          <div className="flex flex-row justify-between cursor-pointer mx-5 md:mx-10">
            <h2 className="text-black text-start text-[16px] md:text-[24px] font-medium">
              What industries can benefit from your AI-driven analytics
              services?
            </h2>
            <Image
              width={20}
          ...
          >
            <div className="answer-container md:ml-5 md:mr-20">
              <p className="text-zinc-400 font-normal text-start text-[16px] md:text-[18px] mt-2 w-full px-5">
                Our AI-driven analytics services are versatile and applicable to
                various industries, including finance, healthcare, retail,
                manufacturing, and more. We tailor analytics solutions to meet
        ...
        >
          <div className="flex flex-row justify-between cursor-pointer mx-5 md:mx-10">
            <h2 className="text-black text-start text-[16px] md:text-[24px] font-medium">
              How do you ensure data security and privacy in AI-driven analytics
              projects?
            </h2>
            <Image
              width={20}
          ...
          >
            <div className="answer-container md:ml-5 md:mr-20">
              <p className="text-zinc-400 font-normal text-start text-[16px] md:text-[18px] mt-2 w-full px-5">
                Data security and privacy are our top priorities. We implement
                stringent security measures, including encryption and access
                controls, to safeguard your data throughout the analytics
                process.
              </p>
            </div>
          </CSSTransition>
        ...
        >
          <div className="flex flex-row justify-between cursor-pointer mx-5 md:mx-10">
            <h2 className="text-black text-[16px] md:text-[24px] font-medium">
              Can your predictive models adapt to changing business conditions?
            </h2>
            <Image
              width={20}
              height={20}
          ...
          >
            <div className="answer-container md:ml-5 md:mr-20">
              <p className="text-zinc-400 font-normal text-start text-[16px] md:text-[18px] mt-2 w-full px-5">
                Yes, our predictive models are designed to adapt to changing
                business conditions. They continuously learn from data and
                adjust their predictions, ensuring they remain relevant and
                accurate.
              </p>
            </div>
          </CSSTransition>
        ...
        >
          <div className="flex flex-row justify-between cursor-pointer mx-5 md:mx-10">
            <h2 className="text-black text-[16px] md:text-[24px] font-medium">
              Do you provide real-time data processing solutions for
          ...
          >
            <div className="answer-container md:ml-5 md:mr-20">
              <p className="text-zinc-400 font-normal text-start text-[16px] md:text-[18px] mt-2 w-full px-5">
                Yes, we offer real-time data processing solutions that are ideal
                for time-sensitive industries like finance and IoT. These
                solutions provide immediate insights and support real-time
                decision-making.
              </p>
            </div>
          </CSSTransition>
        ...
        >
          <div className="flex flex-row justify-between cursor-pointer mx-5 md:mx-10">
            <h2 className="text-black text-[16px] md:text-[24px] font-medium">
              What kind of support and maintenance do you provide for analytics
              solutions?
            </h2>
            <Image
              width={20}
          ...
          >
            <div className="answer-container md:ml-5 md:mr-20">
              <p className="text-zinc-400 font-normal text-start text-[16px] md:text-[18px] mt-2 w-full px-5">
                ...
                your analytics solutions remain optimal. Our team is available
                for updates, enhancements, and addressing any issues that may
                arise.
              </p>
            </div>
          </CSSTransition>
        ...
        >
          <div className="flex flex-row justify-between cursor-pointer mx-5 md:mx-10">
            <h2 className="text-black text-[16px] md:text-[24px] font-medium">
              Can you integrate AI-driven analytics with our existing data
          ...
          >
            <div className="answer-container md:ml-5 md:mr-20">
              <p className="text-zinc-400 font-normal text-start text-[16px] md:text-[18px] mt-2 w-full px-5">
                Yes, we specialize in seamless integration of AI-driven
                analytics with your existing data systems and software, ensuring
