  ...
  return (
    ...
    >
      ...
      <MaxWidthWrapper className="flex flex-col items-start justify-center text-center">
        ...
        <div className="flex flex-col md:flex-row items-start justify-between w-full mt-12 md:mt-20 px-2.5 md:px-0">
          ...
          <div className="flex flex-col items-start space-y-4 w-full md:w-[62%] mt-4 md:mt-0">
            <h4 className=" text-black text-xl md:text-2xl text-start">
      ...
      <div className="textContainer hidden md:block mt-[5rem] md:mt-[8rem]">
        <div ref={slider} className="text2">
          <p ref={firstText}>Artificial Intelligence -</p>
          <p ref={secondText}>Artificial Intelligence -</p>
        </div>
      </div>
...
export default LandingAboutWhite;
