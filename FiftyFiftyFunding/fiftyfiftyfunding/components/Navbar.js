    ...
    <nav className="py-4 px-6 relative">
      <div className="container mx-auto flex items-center justify-between">
        ...
        <div className="ml-auto space-x-8 flex flex-row justify-center items-center hidden md:flex">
          ...
          <PopupButton
            id="netPyDqo"
            className="border border-white text-white font-bold py-2 px-4 rounded inline-flex items-center hover:bg-white hover:text-black cursor-pointer transition"
          >
            ...
            >
              <path
                fillRule="evenodd"
                d="M6.293 9.293a1 1 0 011.414 0L12 13.586V6a1 1 0 112 0v7.586l4.293-4.293a1 1 0 111.414 1.414l-6 6a1 1 0 01-1.414 0l-6-6a1 1 0 010-1.414z"
                clipRule="evenodd"
              ></path>
            </svg>
          </PopupButton>
        ...
        <div className="fixed top-0 left-0 w-full h-screen bg-black z-20 md:hidden">
          <div className="container mx-auto py-4 flex flex-col mt-20 ml-5 gap-10">
            ...
            <PopupButton id="netPyDqo">
              <div className="border border-white text-white font-bold py-2 px-20 rounded inline-flex items-center hover:bg-white hover:text-black cursor-pointer transition">
                <span className="mr-2">APPLY NOW</span>
                <svg
                  className="w-4 h-4"
                  fill="currentColor"
